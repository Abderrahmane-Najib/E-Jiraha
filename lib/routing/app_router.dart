...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // If not authenticated and not on role selection, redirect to role selection
      if (!isAuthenticated && !isOnRoleSelection) {
        return AppRoutes.roleSelection;
      }

      // If authenticated and on role selection, redirect to appropriate dashboard
      if (isAuthenticated && isOnRoleSelection) {
        ...
        pageBuilder: (context, state) {
          ...
          return CustomTransitionPage(
            ...
            child: TriageScreen(
              ...
              isUrgent: queryParams['isUrgent'] == 'true',
            ),
            transitionsBuilder: _slideTransition,
          );
        },
        ...
        pageBuilder: (context, state) {
          ...
          return CustomTransitionPage(
            ...
            child: ChecklistScreen(
              ...
              procedure: queryParams['procedure'] ?? '',
              time: queryParams['time'] ?? '',
              bloc: queryParams['bloc'] ?? '',
        ...
        pageBuilder: (context, state) {
          ...
          return CustomTransitionPage(
            ...
            child: SurgeonDemandeScreen(
              ...
              patientInitials: queryParams['patientInitials'],
              dossierNumber: queryParams['dossierNumber'],
              diagnostic: queryParams['diagnostic'],
              geste: queryParams['geste'],
            ),
            transitionsBuilder: _slideTransition,
          );
        },
