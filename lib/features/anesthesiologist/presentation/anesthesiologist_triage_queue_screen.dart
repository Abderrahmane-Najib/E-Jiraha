...
class AnesthesiologistTriageQueueScreen extends ConsumerWidget {
  const AnesthesiologistTriageQueueScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final triageState = ref.watch(anesthesiaTriageProvider);
        ...
        children: [
          ...
          Expanded(
            child: RefreshIndicator(
              onRefresh: () async {
                await ref.read(anesthesiaTriageProvider.notifier).loadTriageQueue();
              },
                      ...
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () => ref
                                    .read(anesthesiaTriageProvider.notifier)
                                    .loadTriageQueue(),
                          ...
                          : SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${triageState.triageQueue.length} patient${triageState.triageQueue.length > 1 ? 's' : ''} nécessite${triageState.triageQueue.length > 1 ? 'nt' : ''} une évaluation ASA.',
                                    style: TextStyle(
                                      fontSize: 13,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Tous les patients ont été évalués',
            style: TextStyle(
              fontSize: 13,
