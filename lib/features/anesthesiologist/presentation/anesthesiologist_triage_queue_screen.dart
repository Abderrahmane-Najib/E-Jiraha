            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '4 patients nécessitent une évaluation ASA.',
                    style: TextStyle(
                      fontSize: 13,
                  ...
                  ..._patients.map((patient) => Padding(
                    ...
                    child: _TriageCard(
                      patient: patient,
                      onTap: () => context.push(
                        '/anesthesiologist/triage?patientId=${patient.id}&patientName=${Uri.encodeComponent(patient.name)}&patientInitials=${patient.initials}&dossierNumber=${patient.dossierNumber}&service=${Uri.encodeComponent(patient.service)}&isUrgent=${patient.isUrgent}',
                      ),
                    ),
                  )),
                ],
